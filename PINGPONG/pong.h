...
public:
    ...
    string getposXstr() {
        return std::to_string(this->posX);
    }

    string getposYstr() {
        return std::to_string(this->posY);
    }
...
public:
    ...
    Pong(HWND hWnd) {
        ...
        this->setBolPosX(rect.right/2);
        this->setBolPosY(rect.bottom/2);
    }
    ...
    void setup(Gamer* gamer1, Gamer* gamer2, HWND hWnd) {
        RECT rect;
        GetClientRect(hWnd, &rect);
        ...
        gamer1->setposX(30);
        gamer1->setposY(rect.bottom / 2);

        gamer2->setposX(rect.right - 30);
        gamer2->setposY(rect.bottom/2);
    ...
    void moverBol(Gamer* gamer1, Gamer* gamer2) {
        ...
        if (this->getBolPosX() + this->getDirectX() >= 1424) {
            this->setBolPosX(712);
            this->setBolPosY(350);
            this->setDirectX(0);
            this->setDirectY(0);
            if (gamer1->getScore() < 10)
        ...
        if (this->getBolPosY() + this->getDirectY() < 700
